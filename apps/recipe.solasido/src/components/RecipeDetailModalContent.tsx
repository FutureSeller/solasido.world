...
interface RecipeDetailModalContentProps {
  recipe: Recipe;
}

export function RecipeDetailModalContent({ recipe }: RecipeDetailModalContentProps) {
  ...
  return (
    <div className="grid min-h-0 gap-5 sm:gap-6 lg:h-full lg:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.92fr)]">
      ...
      <div className="flex min-h-0 min-w-0 flex-col pr-1 lg:overflow-y-auto lg:overscroll-contain">
        ...
        <section className="py-5">
          ...
          <pre className="text-base m-0 whitespace-pre-wrap rounded-[20px] border border-[var(--line)] bg-[#fbf7f1] p-4 font-sans text-sm leading-7 sm:p-5 sm:text-[15px]">
